...
const char *Acamarachi::Vulkan::vkErrorToString(VkResult res)
{
        return string_VkResult(res);
}

void Acamarachi::Vulkan::transitionImage(VkCommandBuffer cmd, VkImage img, VkImageLayout srcLayout, VkImageLayout dstLayout)
{
